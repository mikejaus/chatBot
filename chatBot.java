...
public class chatBot {
	...
	public static void main(String[] args) {
		...
		do {
			userInput = JOptionPane.showInputDialog("What do you like about IT? eg. Programming, Networking, Hacking, Hardware, People"); // 1st Question
			if (userInput.toLowerCase().contains("?".toLowerCase())) {
				JOptionPane.showMessageDialog(null, "I will be asking the questions "+userName+"!"); // ? Input detection
		...
		do {
			userInput = JOptionPane.showInputDialog("How do you get to uni? e.g. Car, Tram, Bike, Walk, etc.."); // 2nd Question
			if (userInput.toLowerCase().contains("?")) {
				...
				userInput = JOptionPane.showInputDialog("How far do you have to ride? (in kilometres)"); // Using < and > to determine different outputs
		...
		do {
			userInput = JOptionPane.showInputDialog("Where do you like to study? e.g. RMIT, Home, Bed, Library etc.."); // 3rd Question
			if (userInput.toLowerCase().contains("?")) {
				JOptionPane.showMessageDialog(null, "I will be asking the questions "+userName+"!"); // ? Input detection
				...
				userInput = JOptionPane.showInputDialog(null, "What number building? i personally like 10"); // Will be putting "University" and "RMIT" detection into an array
				...
				JOptionPane.showMessageDialog(null, "Being at home makes you more relaxed but you can also get distracted easily"); // Will put Home, House, bed and room into its own array
				a++; // Adding 1 to the value of a to break the while loop
		...
		do {
			...
			if (userInput.toLowerCase().contains("?")) {
				...
				userInput = JOptionPane.showInputDialog("Which version of windows? e.g. 10, 8, 7, XP"); // Checking which version and giving a comment about said version
